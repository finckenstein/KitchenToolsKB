...
from utility import paths as path
...
def analyze_sentence(sen, c, s):
    ...
    while sentence_i < len(sen):
        ...
        cv_kitchenware_dict = s.get_cv_detected_kitchenware()
        s.increment_word_counter()
        # if not s.video_is_done:
...
if __name__ == '__main__':
    ...
    for recipe in recipe_rows:
        ...
        cv_detected_kitchenware_per_second_of_vid = [{'bowl': []}, {'bowl': []}, {'whisk': 'bowl'}, [], [], {'bowl': []}, {'bowl': []}, {'bowl': []}, {'bowl': []}, {'whisk': 'bowl'}, {'bowl': []}, {'bowl': []}, {'bowl': []}, [], [], [], [], [], [], [], [], [], [], [], [], {'baking-sheet': []}, [], [], [], [], [], {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl', 'turner': 'pan'}, {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl'}, {'pinch-bowl': 'bowl'}, [], [], {'turner': 'pan'}, {'pan': [], 'bowl': []}, {'pan': [], 'bowl': []}, {'pan': [], 'bowl': []}, {'pan': [], 'bowl': []}, {'pan': [], 'bowl': []}, {'pan': [], 'bowl': []}, {'pan': [], 'bowl': []}, [], [], {'pinch-bowl': 'pan'}, {'silicone-spatula': 'bowl'}, {'pinch-bowl': 'bowl'}, {'bowl': []}, {'bowl': []}, {'bowl': []}, {'bowl': []}, {'bowl': []}, {'bowl': []}, {'pinch-bowl': 'pan'}, [], [], [], [], [], [], [], [], [], [], [], [], [], [], {'bowl': []}, {'bowl': []}, {'whisk': 'bowl'}, {'whisk': 'bowl'}, {'bowl': []}, {'bowl': []}, [], [], [], [], [], [], [], {'plate': []}, [], [], [], [], [], [], {'bowl': []}, {'bowl': []}, {'bowl': []}, {'bowl': []}, {'bowl': []}]
