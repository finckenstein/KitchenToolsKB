...
def print_findings(dic):
    ...
    print("All Cutlery: ", dic['All_Cutlery'], "\n")
    ...
    print("All Containers: ", dic['All_Containers'], "\n")
    ...
    print("All Glasses: ", dic['All_Glasses'], "\n")

    print("Foods: ", dic['Potential Foods'])
    print("Other: ", dic['Other detections'])
    print("\n\n\n")
...
if __name__ == '__main__':
    ...
    csv_headers = ['Recipe Title', 'Recipe URL', 'Recipe Video',
                   'Most_Accurate_Cutlery', 'Most_Occurring_Cutlery', 'Last_Detected_Cutlery', 'All_Cutlery',
